...
-- specific LC dataset
torch.include('dp', 'data/flickr8k.lua')
...
-- LC: add propagator captioner, optimizer captioner, evaluate captioner
-- note: lua files have order
torch.include('dp', 'propagator/propagatorcaptioner.lua')
torch.include('dp', 'propagator/optimizercaptioner.lua')
torch.include('dp', 'propagator/evaluatorcaptioner.lua')
...
-- LC: add perplexity captioner 
torch.include('dp', 'feedback/perplexitycaptioner.lua')
